...
//         />
//         <Button className="w-full bg-gray-100 dark:bg-gray-100/10 dark:text-gray-300" onClick={onOpen}>
...
//                   {userInfo?.name}
//                   {userInfo?.verified && <Verified className="text-primaryColor" />}
//                 </p>
//                 <span className="text-xs text-default-400 whitespace-nowrap">Public</span>
//               </div>
//             </div>
//           </ModalHeader>
...
//                 <ImageUpload label="Upload Post Images" name="images" setImageFiles={setImageFiles} />
//                 <ReusableSelect
//                   label="Status"
//                   name="status"
//                   options={[
